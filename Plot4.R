...
#plot 4
#using PNG function for making PNG file for this one as it seems to work better
...
legend("topright", legend = c("Sub_mettering_1","Sub_mettering_2", "Sub_mettering_3"), lty=c(1,1), lwd=c(2,2,2),col=c("green", "red", "blue"), cex = 1, inset = 0, bty = "n")
